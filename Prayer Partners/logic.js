...
function getRandomNumberBoys(max) { //even number of boys, update if change
...
function getRandomNumberEverybody(max) { //odd number of memebers, update if change
	var rand = Math.floor( Math.random() * ((max - 0) - 0) + 0 ); 
	return rand;
}
